        ...
        <div>
          ...
          {part.priceSek != null ? (
            ...
            <>
              ...
              <ChatTrigger
                context={{
                  topic: "Pris på förfrågan",
                  sku: part.sku,
                  partName: part.name,
                  url: `${SITE_URL}/bildelar/${part.sku}`,
                }}
                prefill={`Hej! Jag är intresserad av — vad är priset för ${part.name} (Art.nr ${part.sku})?`}
                fallbackHref={`https://wa.me/4617121002?text=${waText(part.name, part.sku, "Hej! Jag är intresserad av — vad är priset för")}`}
                ariaLabel="Öppna chatten och fråga om pris"
