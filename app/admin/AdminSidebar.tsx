    ...
    <aside className="w-16 lg:w-60 shrink-0 border-r border-[var(--color-dark-500)] bg-[var(--color-dark-800)] flex flex-col">
      ...
      <nav className="flex-1 overflow-y-auto py-4 px-2 space-y-0.5">
        ...
        <div className="pt-6 pb-2 px-3">
          <h3 className="text-[10px] font-bold text-[var(--color-text-muted)] uppercase tracking-widest hidden lg:block">
            Externt
          </h3>
          <div className="block lg:hidden h-px bg-[var(--color-dark-500)]" />
        </div>
      ...
      <div className="p-3 border-t border-[var(--color-dark-500)] space-y-1">
        ...
        >
          ...
          <span className="hidden lg:block">Till sajten</span>
        </Link>
